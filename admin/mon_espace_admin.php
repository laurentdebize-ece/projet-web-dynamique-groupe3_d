    ...
    charset=utf8',
        ...
        <div class="casier-compte">
            ...
            <div class="casier-compte-place-buttons">
                <buttonA id="modifier">Modifier</buttonA>
                ...
                <buttonA id="retour"><a href="../admin.php">Retour</a></buttonA>
                <buttonA id="annuler">Annuler</buttonA>
                <buttonA id="confirmer"> Confirmer </buttonA>
            </div>

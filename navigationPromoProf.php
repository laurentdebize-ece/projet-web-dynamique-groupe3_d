            ...
            <div class="col-sm-4" id=menuDeroulePromo>
                <p>
                    ...
                    while ($donnees = $response->fetch()) {
                        $response2 = $bdd->query("SELECT * FROM professeurs AS pr, enseignerclassmatprof AS cmp, classe AS c WHERE pr.IdProf = '$ID' AND pr.IdProf =cmp.IdProf AND cmp.IdClasse=c.IdClasse ORDER BY classeNum");
